...
async function isBackendAvailable(): Promise<boolean> {
  try {
    const response = await fetch(`${BACKEND_URL}/health?t=${Date.now()}`, {
      method: 'GET',
...
async function fetchRealGraphData(maxNodes: number, includeRelationships: string[]): Promise<GraphData | null> {
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/graph?t=${Date.now()}`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const includeRelationships = req.query.relationships 
      ...
      : ["ESTABLISHES", "DEFINES", "REGULATES", "PROTECTS", "GOVERNED_BY", "REQUIRES", "HAS_PRINCIPLE", "ALIGNS_WITH", "CONTRADICTS", "RELATES_TO", "PROVIDES", "APPLIES_TO", "INCLUDES", "ENFORCED_BY", "AFFECTS", "ENFORCES", "HAS_SPECIAL", "judicial", "foundational", "legislative", "regulatory", "compliance", "legal", "system", "AMENDED_BY", "UPDATED_BY", "COMPLEMENTS", "BASED_ON", "SUPPLEMENTS", "ENFORCES", "REQUIRED_BY", "IMPACTS", "complements", "enhances", "extends", "supports", "implements", "influences", "facilitates", "modernizes", "strengthens", "tax_system", "tax_compliance", "governance", "reporting", "financial_services", "market_regulation", "digital_security", "payment_systems", "development", "property_management", "employment_policy", "investment", "environmental_compliance", "sustainability", "enforcement", "legal_system", "commercial_regulation", "consumer_rights", "competition", "dispute_resolution", "legal_procedure", "financial_services", "market_regulation", "compliance", "digital_infrastructure", "sustainability", "transport_regulation", "trade_regulation", "content_regulation", "privacy_compliance", "employment_standards", "service_regulation", "organization_regulation", "ngo_regulation", "development_regulation", "sustainable_development", "marine_resources", "environmental_compliance", "resource_management", "alternative_to", "supports", "governs", "influences", "requires", "protects", "healthcare_regulation", "medical_standards", "research_regulation", "genetic_privacy", "biotechnology_regulation", "aerospace_regulation", "quantum_security", "ai_privacy", "digital_assets", "virtual_reality", "clean_energy", "emissions_reduction", "sustainable_development", "sustainable_construction", "climate_resilience", "identity_privacy", "monetary_policy", "payment_systems", "asset_regulation", "national_security", "digital_regulation", "energy_policy", "trade_regulation", "environmental_compliance"];
